...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 09, 2024 at 08:01 AM
...
(47, '1', '372864', '2024-11-09 06:40:56');
...
--
ALTER TABLE `email_verifications`
  MODIFY `verification_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=48;
...
--
-- Constraints for table `activities_complied`
--
ALTER TABLE `activities_complied`
  ADD CONSTRAINT `fk_activity_complied` FOREIGN KEY (`activity_id`) REFERENCES `activities` (`activity_id`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_student_complied` FOREIGN KEY (`student_id`) REFERENCES `users` (`user_id`) ON DELETE CASCADE;
...
--
ALTER TABLE `events`
  ADD CONSTRAINT `fk_user_events` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`) ON DELETE CASCADE;

--
-- Constraints for table `exams`
--
ALTER TABLE `exams`
  ADD CONSTRAINT `fk_section_exams` FOREIGN KEY (`section_id`) REFERENCES `sections` (`section_id`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_section_subject_exams` FOREIGN KEY (`section_subject_id`) REFERENCES `section_subjects` (`section_subject_id`) ON DELETE CASCADE;

--
-- Constraints for table `grade_scores`
--
ALTER TABLE `grade_scores`
  ADD CONSTRAINT `fk_parent_grade_scores` FOREIGN KEY (`parent_id`) REFERENCES `grading_platforms` (`grading_platform_id`) ON DELETE CASCADE;

--
-- Constraints for table `grading_categories`
--
ALTER TABLE `grading_categories`
  ADD CONSTRAINT `fk_platform_categories` FOREIGN KEY (`grading_platform_id`) REFERENCES `grading_platforms` (`grading_platform_id`) ON DELETE CASCADE;

--
-- Constraints for table `grading_platforms`
--
ALTER TABLE `grading_platforms`
  ADD CONSTRAINT `fk_section_subject_platforms` FOREIGN KEY (`section_subject_id`) REFERENCES `section_subjects` (`section_subject_id`) ON DELETE CASCADE;

--
-- Constraints for table `grading_scores`
--
ALTER TABLE `grading_scores`
  ADD CONSTRAINT `fk_score_column` FOREIGN KEY (`grading_score_column_id`) REFERENCES `grading_score_columns` (`grading_score_column_id`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_student_scores` FOREIGN KEY (`student_id`) REFERENCES `users` (`user_id`) ON DELETE CASCADE;

--
-- Constraints for table `grading_score_columns`
--
ALTER TABLE `grading_score_columns`
  ADD CONSTRAINT `fk_category_columns` FOREIGN KEY (`grading_category_id`) REFERENCES `grading_categories` (`grading_category_id`) ON DELETE CASCADE;
...
--
ALTER TABLE `post_comments`
  ADD CONSTRAINT `fk_post_comments` FOREIGN KEY (`post_id`) REFERENCES `posts` (`post_id`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_user_comments` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`) ON DELETE CASCADE;

--
-- Constraints for table `post_likes`
--
ALTER TABLE `post_likes`
  ADD CONSTRAINT `fk_post_likes` FOREIGN KEY (`post_id`) REFERENCES `posts` (`post_id`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_user_likes` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`) ON DELETE CASCADE;

--
-- Constraints for table `post_medias`
--
ALTER TABLE `post_medias`
  ADD CONSTRAINT `fk_post_medias` FOREIGN KEY (`post_id`) REFERENCES `posts` (`post_id`) ON DELETE CASCADE;
...
--
ALTER TABLE `resources`
  ADD CONSTRAINT `fk_resources_group` FOREIGN KEY (`resources_group_id`) REFERENCES `resources_groups` (`resources_group_id`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_section_resources` FOREIGN KEY (`section_id`) REFERENCES `sections` (`section_id`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_section_subject_resources` FOREIGN KEY (`section_subject_id`) REFERENCES `section_subjects` (`section_subject_id`) ON DELETE CASCADE;

--
-- Constraints for table `resources_groups`
--
ALTER TABLE `resources_groups`
  ADD CONSTRAINT `fk_section_groups` FOREIGN KEY (`section_id`) REFERENCES `sections` (`section_id`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_section_subject_groups` FOREIGN KEY (`section_subject_id`) REFERENCES `section_subjects` (`section_subject_id`) ON DELETE CASCADE;

--
-- Constraints for table `schedule_items`
--
ALTER TABLE `schedule_items`
  ADD CONSTRAINT `fk_schedule_items` FOREIGN KEY (`schedule_id`) REFERENCES `schedules` (`schedule_id`) ON DELETE CASCADE;

--
-- Constraints for table `sections`
--
ALTER TABLE `sections`
  ADD CONSTRAINT `fk_adviser_sections` FOREIGN KEY (`adviser_id`) REFERENCES `professors` (`professor_id`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_course_sections` FOREIGN KEY (`course_id`) REFERENCES `courses` (`course_id`) ON DELETE CASCADE;

--
-- Constraints for table `section_students`
--
ALTER TABLE `section_students`
  ADD CONSTRAINT `fk_section_students` FOREIGN KEY (`section_id`) REFERENCES `sections` (`section_id`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_student_sections` FOREIGN KEY (`student_id`) REFERENCES `users` (`user_id`) ON DELETE CASCADE;

--
-- Constraints for table `staffs`
--
ALTER TABLE `staffs`
  ADD CONSTRAINT `fk_department_staffs` FOREIGN KEY (`department_id`) REFERENCES `departments` (`department_id`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_user_staffs` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`) ON DELETE CASCADE;

--
-- Constraints for table `sticky_notes`
--
ALTER TABLE `sticky_notes`
  ADD CONSTRAINT `fk_professor_notes` FOREIGN KEY (`professor_id`) REFERENCES `professors` (`professor_id`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_section_notes` FOREIGN KEY (`section_id`) REFERENCES `sections` (`section_id`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_user_notes` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`) ON DELETE CASCADE;

--
-- Constraints for table `subjects`
--
ALTER TABLE `subjects`
  ADD CONSTRAINT `fk_course_subjects` FOREIGN KEY (`course_id`) REFERENCES `courses` (`course_id`) ON DELETE CASCADE;
COMMIT;
