...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 09, 2024 at 09:26 AM
...
(48, '32', '335084', '2024-11-09 07:57:42'),
(49, '10', '135570', '2024-11-09 08:14:08');
...
(1, '4 - A', 4, 1, 1, 1, 0, '2024-11-09 08:24:14');
...
(1, 1, 1, 4, 0, 0, '2024-11-09 08:25:14');
...
(1, 'Subject 1', 'AB', 1, 1, '2024-11-09 08:24:59');
...
(54, '', 'josephsua@gmail.com', 'd41d8cd98f00b204e9800998ecf8427e', 'Joseph Suatengco', 'Joseph', 'S.', 'Suatengco', '0000-00-00', 0, 1, '2024-11-09 07:55:13', 1),
(55, '', 'joshua@gmail.com', 'd41d8cd98f00b204e9800998ecf8427e', 'Joshua Suatengco', 'Joshua', 'S.', 'Suatengco', '0000-00-00', 0, 1, '2024-11-09 07:55:13', 1),
(56, '', 'britney@gmail.com', 'd41d8cd98f00b204e9800998ecf8427e', 'Britney Suatengco', 'Britney', 'S.', 'Suatengco', '0000-00-00', 0, 1, '2024-11-09 07:55:13', 1),
(57, '', 'kevon@gmail.com', 'd41d8cd98f00b204e9800998ecf8427e', 'Kevon Looney', 'Kevon', 'S.', 'Looney', '0000-00-00', 0, 1, '2024-11-09 07:55:13', 1),
(58, '', 'stephen@gmail.com', 'd41d8cd98f00b204e9800998ecf8427e', 'staphen Looney', 'staphen', 'S.', 'Looney', '0000-00-00', 0, 1, '2024-11-09 07:55:13', 1);
...
--
ALTER TABLE `activities_complied`
  MODIFY `comply_id` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `email_verifications`
  MODIFY `verification_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=50;
...
--
ALTER TABLE `grade_scores`
  MODIFY `grade_score_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `grading_categories`
--
ALTER TABLE `grading_categories`
  MODIFY `grading_category_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `grading_platforms`
--
ALTER TABLE `grading_platforms`
  MODIFY `grading_platform_id` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `resources_groups`
  MODIFY `resources_group_id` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `schedule_items`
  MODIFY `schedule_item_id` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `section_students`
  MODIFY `section_student_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `sticky_notes`
  MODIFY `sticky_note_id` int(11) NOT NULL AUTO_INCREMENT;
