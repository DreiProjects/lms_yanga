...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 15, 2024 at 04:53 AM
...
(5, 4, 'Activity 1', 'Please Describe what is Unity', '2024-11-15', NULL, 'Text', 'On Going', 0, '2024-11-13 07:38:31');
...
(61, '1', '564882', '2024-11-14 04:54:54'),
(62, '10', '908668', '2024-11-14 04:56:03'),
(63, '32', '472270', '2024-11-14 04:56:58');
...
(6, 3, 10, 0, '2024-11-14 05:04:29'),
(7, 3, 10, 0, '2024-11-14 05:04:59');
...
(3, 6, 9, 'short-answer', 'fqwf', 0, 0, '2024-11-14 05:04:29'),
(4, 6, 10, 'dropdown', 'YOU', 12, 0, '2024-11-14 05:04:29'),
(5, 6, 11, 'checkbox', 'Array', 0, 0, '2024-11-14 05:04:29'),
(6, 7, 9, 'short-answer', 'fqwf', 0, 0, '2024-11-14 05:04:59'),
(7, 7, 10, 'dropdown', 'YOU', 12, 0, '2024-11-14 05:04:59'),
(8, 7, 11, 'checkbox', 'Array', 0, 0, '2024-11-14 05:04:59');
...
(2, 4, 'Subject Capstone Project and Research 2 Schedule', 1, '2024-11-13 06:59:41');
...
(2, 2, 'Monday', '08:00:00', '10:01:00', 1, '2024-11-13 06:59:41'),
(3, 2, 'Wednesday', '09:00:00', '18:30:00', 1, '2024-11-13 06:59:41'),
(4, 2, 'Tuesday', '10:00:00', '12:30:00', 1, '2024-11-13 06:59:41');
...
(4, 4, 4, 4, 2, 0, 0, '2024-11-10 21:02:49'),
(5, 4, 5, 7, 0, 0, 0, '2024-11-13 06:49:26'),
(6, 4, 6, 7, 0, 4, 0, '2024-11-13 06:51:54');
...
--
ALTER TABLE `activities_complied`
  MODIFY `comply_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `email_verifications`
  MODIFY `verification_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=64;
...
--
ALTER TABLE `form_questions`
  MODIFY `form_question_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;

--
-- AUTO_INCREMENT for table `form_question_choices`
--
ALTER TABLE `form_question_choices`
  MODIFY `form_question_choice_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
...
--
ALTER TABLE `schedule_items`
  MODIFY `schedule_item_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
